...
* FEATUTE: add support for build the freebsd/amd64. See [this pull request](https://github.com/VictoriaMetrics/victorialogs-datasource/pull/281).
  Tank to @AlexanderThaller
