...
* FEATURE: add a visual query builder. Construct queries by chaining typed pipes (`filter`, `stream`, `aggregate`, `modify`, `sort`, `limit`) through an interactive UI with field name/value dropdowns and keyboard navigation. See [#578](https://github.com/VictoriaMetrics/victorialogs-datasource/issues/578).
