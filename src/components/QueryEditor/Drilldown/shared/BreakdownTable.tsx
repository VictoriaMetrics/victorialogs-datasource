...
interface BreakdownTableProps {
  ...
  /** Header of the label column; "Value" by default */
  labelHeader?: string;
  /** When set, labels render as clickable links (used by the stream-fields level to open a field) */
...
const getStyles = (theme: GrafanaTheme2) => ({
  ...
  // same typography as labelText, plus link affordances for the clickable variant
  labelButton: css({
    fontFamily: theme.typography.fontFamilyMonospace,
    fontSize: theme.typography.bodySmall.fontSize,
    overflowWrap: 'anywhere',
