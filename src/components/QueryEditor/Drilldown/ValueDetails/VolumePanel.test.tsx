...
beforeAll(() => {
  ...
  // jsdom always measures 0, so report a real width and let useElementWidth mount the panel
...
describe('VolumePanel', () => {
  ...
  it('keeps rendering the panel (instead of the placeholder) while loading if a previous series is still present', () => {
    ...
    // a refetch keeps the previous series in `data`, so the panel must stay mounted and dimmed
    // rather than turning into the placeholder
