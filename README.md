   ...
   ```yaml
    ...
    services:
       grafana:
         ...
         environment:
         - GF_INSTALL_PLUGINS=https://github.com/VictoriaMetrics/victorialogs-datasource/releases/download/v0.11.0/victorialogs-datasource-v0.11.0.zip;victorialogs-datasource
...
``` yaml
plugins:
  - https://github.com/VictoriaMetrics/victorialogs-datasource/releases/download/v0.11.0/victorialogs-datasource-v0.11.0.zip;victorialogs-datasource
```
