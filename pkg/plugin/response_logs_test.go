...
func Test_parseInstantResponse(t *testing.T) {
	...
	// newFrame assembles an expected logs frame from its four fields.
	newFrame := func(timeFd, lineField, idField, labelsField *data.Field) backend.DataResponse {
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{tsRaw, msgRaw, ""}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, idField, labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{"", "", ""}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{ts1, "", ""}, row{ts2, "", ""}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{tsRaw, msg, streamID}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{tsRaw, msg, ""}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{"", "507", ""}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{tsRaw, str, streamID}), labelsField)
		},
	}
	f(o)
	...
	o = opts{
		...
		want: func() backend.DataResponse {
			...
			return newFrame(timeFd, lineField, newIDField(row{tsRaw, "123", ""}), labelsField)
		},
	}
	f(o)
